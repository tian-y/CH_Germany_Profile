...
``` {r figure6, echo = F, message = F, fig.cap = 'Germany – ODA to data and statistics by type of aid, 2010 – 2020', fig.align = "center", fig.topcaption=TRUE}
...
``` {r figure7, echo = F, message = F, fig.cap = 'Germany – ODA to data and statistics by channel', fig.align = "center", fig.topcaption=TRUE}
